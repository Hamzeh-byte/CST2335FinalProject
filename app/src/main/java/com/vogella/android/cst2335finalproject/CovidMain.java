...
/**
 * This is the application's home page. Here, the user is asked to enter a country and select a
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchButton.setOnClickListener(click -> {
            ...
            if(country.equalsIgnoreCase("")) {
                Snackbar.make(searchButton, "Country field cannot be empty!", Snackbar.LENGTH_LONG).show();
            }
